...
def main(path,dens=1, alpha=1e-3, scat_mode = 1):
    #
    ...
    ### Index 114 roughly corresponds to r0 (planet position). We have to do this because nu_cgs.shape is (300,).
    D_cgs        = nu_cgs[114]                           # We assume the diffusion by turbulence = viscosity by turbulence
    ...
    with open('radmc3d.inp','w+') as f:
        ...
        f.write(f'scattering_mode_max = {scat_mode}\n')
        f.write('iranfreqmode = 1\n')

    return sigma_dust_2d
